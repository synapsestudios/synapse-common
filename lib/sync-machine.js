...
var SyncMachine = {
    ...
    unsync: function() {
        ...
        if ((state = this._syncState) === SYNCING || state === SYNCED) {
            ...
            this.emit(this._syncState, this, this._syncState);
            this.emit(STATE_CHANGE, this, this._syncState);
        }
    },
    beginSync: function() {
        var state;
...
handlerFn = function(event) {
    SyncMachine[event] = function(callback, context) {
        if (context == null) {
            context = this;
        }
